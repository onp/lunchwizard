...
def scoreTable():
    """Serve a raw table of all scores."""
...
def scoreEntry():
    ...
    data = [
        {"players": [{"name": "Sean"}, {"name": "Calvin"}, {"name": "Omer"},
                     {"name": "Farah"}, {"name": "Jamie"}]},
        {"players": [{"name": "Oskar"}, {"name": "Jeff"}, {"name": "Spencer"},
                     {"name": "Burkeley"}, {"name": "Dave"}]}
    ]
